...
## Relational & SQLite Schemas

### `route_plans`
Stores plan-scoped, multi-user route loop choices generated by the planner.
...
Immutable concept identifiers for national crosswalking.

```sql
CREATE TABLE taxon_concept_registry (
    concept_id TEXT PRIMARY KEY, -- Sidetrack UUID
    canonical_common_name TEXT NOT NULL,
    canonical_scientific_name TEXT NOT NULL,
    ebird_code TEXT UNIQUE,
    gbif_taxon_key INTEGER,
    inaturalist_id INTEGER,
    taxonomy_version TEXT NOT NULL DEFAULT 'Clements-2025'
);
```

### `taxon_support`
Decouples scientific/ecological model support from media asset availability.

```sql
CREATE TABLE taxon_support (
    concept_id TEXT PRIMARY KEY FOREIGN KEY REFERENCES taxon_concept_registry(concept_id),
    taxonomy_known BOOLEAN NOT NULL DEFAULT 1,
    occurrence_data_available BOOLEAN NOT NULL DEFAULT 0,
    effort_model_available BOOLEAN NOT NULL DEFAULT 0,
    calibrated_model_available BOOLEAN NOT NULL DEFAULT 0,
    field_cue_reviewed BOOLEAN NOT NULL DEFAULT 0,
    photo_available BOOLEAN NOT NULL DEFAULT 0,
    audio_available BOOLEAN NOT NULL DEFAULT 0,
    sensitive BOOLEAN NOT NULL DEFAULT 0
);
```

### `field_cue_profile`
Region and season aware observation guidance.

```sql
CREATE TABLE field_cue_profile (
    cue_profile_id TEXT PRIMARY KEY,
    concept_id TEXT NOT NULL FOREIGN KEY REFERENCES taxon_concept_registry(concept_id),
    region_scope TEXT NOT NULL DEFAULT 'US-MO-KC',
    season_scope TEXT NOT NULL DEFAULT 'all_year',
    audience TEXT NOT NULL DEFAULT 'beginner',
    where_to_look TEXT NOT NULL,
    listen_for TEXT NOT NULL,
    confusion_taxa_json TEXT NOT NULL DEFAULT '[]',
